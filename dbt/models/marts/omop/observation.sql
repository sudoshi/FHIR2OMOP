...
select
    ...
    coalesce(l.concept_id, {{ var('unknown_concept_id') }})                             as observation_concept_id,
    date(o.effective_datetime)                                                           as observation_date,
    o.effective_datetime                                                                 as observation_datetime,
    ...
    vs.concept_id                                                                        as value_as_concept_id,
    ...
    o.fhir_observation_id                                                                as observation_source_value,
    coalesce(l.concept_id, {{ var('unknown_concept_id') }})                              as observation_source_concept_id,
...
from obs o
join p on p.person_source_value = o.patient_ref
left join loinc l on l.concept_code = o.loinc_code
left join snomed_values vs on vs.concept_code = o.value_snomed_code
